...
const EXIT_MAX_ORDER_QUANTITY = 50;
...
const POSITION_REBALANCE_MAX_ORDER_QUANTITY = 50;
const POSITION_REBALANCE_BASELINE_DRIFT_SHARE = 0.03;
const POSITION_REBALANCE_BASELINE_DRIFT_MULTIPLIER = 1.5;
...
export class BotManager {
    ...
    async start() {
        ...
        this.syncActivityWithUsers();
        this.logger.log(`Initialized ${this.runtimes.length} bot runtimes.`);
    }
    ...
    resume() {
        ...
        this._active = true;
        this.logger.log(`Resumed ${this.runtimes.length} bot runtimes; ${this.userToSocket.size} user(s) connected.`);
    }
    ...
    pause() {
        ...
        this._active = false;
        this.logger.log('Paused bot runtimes; no users connected.');
    }
